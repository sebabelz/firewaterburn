...
#define DL_BEGIN(prim) ((31UL<<24)|(((prim)&15UL)<<0))
...
#define DL_LINE_WIDTH(width) ((14UL<<24)|(((width)&4095UL)<<0))
#define DL_MACRO            	0x25000000UL // requires OR'd arguments
#define DL_POINT_SIZE(size) ((13UL<<24)|(((size)&8191UL)<<0))
...
#define DL_TAG(s) ((3UL<<24)|(((s)&255UL)<<0))
